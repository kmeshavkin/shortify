...
var fakelish_1 = require("fakelish");
function capitalLetter(str) {
    return str[0].toUpperCase() + str.slice(1);
}
function generateSentence(length, maxWordLength) {
    return __awaiter(this, void 0, void 0, function () {
        var str, _a, _b, _c, _d, twoDigitNumber;
            ...
            switch (_e.label) {
                ...
                case 4:
                    ...
                    twoDigitNumber = Math.floor(Math.random() * 100)
                        .toString()
                        .padStart(2, '0');
                    return [2 /*return*/, str.slice(0, length - 2) + twoDigitNumber];
            }
        });
    });
}
