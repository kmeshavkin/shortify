...
router.get('/:code', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                return [4 /*yield*/, Link_1.LinkModel.findOne({ code: req.params.code })];
            case 1:
                link = _a.sent();
                if (!link)
                    return [2 /*return*/, res.status(404).json('Link not found')];
                if (link.clicksLeft === -1)
                    return [2 /*return*/, res.redirect(link.from)];
                if (!(link.clicksLeft > 1)) return [3 /*break*/, 3];
                link.clicksLeft--;
