...
router.post('/generate', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                _b.sent();
                return [2 /*return*/, res.status(201).json({ link: link })];
            case 3:
                error_1 = _b.sent();
...
router.post('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Link_1.LinkModel.findById(req.params.id)];
            case 1:
                link = _a.sent();
                return [2 /*return*/, res.json(link)];
            case 2:
                error_3 = _a.sent();
                return [2 /*return*/, res.status(500).json({ message: 'Something went wrong' })];
            case 3: return [2 /*return*/];
...
router.post('/delete/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var session, links, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                session = req.session;
                return [4 /*yield*/, Link_1.LinkModel.deleteOne({ _id: req.params.id })];
            case 1:
                _a.sent();
                return [4 /*yield*/, Link_1.LinkModel.find({
                        owner: session.userId || session.id
